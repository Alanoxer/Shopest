  ...
  return (
    ...
    <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between">
      <div className="flex items-center mb-2 sm:mb-0">
        {/* <img src="/placeholder.svg?height=34&width=134" alt="Mercado Libre Logo" className="h-8 w-auto" /> */}
      ...
      <Link href={`/new`} className={buttonVariants({ variant: "outline" })}>Vender</Link>
        <DropdownMenu>
            ...
            <DropdownMenuContent>
              ...
              <DropdownMenuItem><Link href={"/type/Ropa y Accesorios/0"}>Ropa y Accesorios</Link></DropdownMenuItem>
              <DropdownMenuItem><Link href={"/type/Hogar y Muebles/0"}>Hogar y Muebles</Link></DropdownMenuItem>
              <DropdownMenuItem><Link href={"/type/Deportes y Fitness/0"}>Deportes y Fitness</Link></DropdownMenuItem>
            </DropdownMenuContent>
        </DropdownMenu>
