...
export default function Header(){
  ...
  return (
    ...
    <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between">
      ...
      <Link href={"/products/page/cualquiera/createdAt/0"} className={buttonVariants({ variant: "outline", size:"sm" })}>Marketplace</Link>
      <Link href={`/services/page/0`} className={buttonVariants({ variant: "outline", size:"sm" })}>Servicios</Link>
      <Link href={`/jobs/page/0`} className={buttonVariants({ variant: "outline", size:"sm" })}>Trabajos</Link>
      <Link href={`/community/page/0`} className={buttonVariants({ variant: "outline", size:"sm" })}>Comunidad</Link>
      ...
      <div className="flex items-center space-x-1 ml-8 mt-2 sm:mt-0">
      ...
      <>
        ...
        <Link href={"/register"} className={buttonVariants({ variant: "default", size:"sm" })}>Register</Link>
      </>
      }
      </div>
