...
export default function Pagination(){
    ...
    <div className="max-w-full md:max-w-screen-md lg:max-w-screen-lg xl:max-w-screen-xl mx-auto bg-slate-800 p-6 rounded-lg shadow-sm">

        <div className="flex justify-center">
            <nav className="flex space-x-2" aria-label="Pagination">
                <button onClick={()=>{
                    router.push(`/product/${params.keyword}/${params.pagination - 1}`)
